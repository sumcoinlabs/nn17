...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "We Forgot What Dr. King Believed In - The Times";
        CTransaction txNew;
        txNew.nTime = 1524241200;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x97b2efb168a3fab9cf4d0e08b90b3410230ba21e445fbe38003cb9895cba710c"));
        block.print();
