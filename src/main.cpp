...
int CMerkleTx::GetBlocksToMaturity() const
{
  ...
  //  return max(0, (nCoinbaseMaturity+20) - GetDepthInMainChain());  // old value adds 20 to coinbase. removed
}
...
bool LoadBlockIndex()
{
    ...
    {
#ifdef TESTING
        hashGenesisBlock = uint256("0000001bd1c72d5de6244be7b0e27115f513ee37db56f44724761d99fd29dd5b");
...
if (fDebug && GetBoolArg("-printpriority"))
    ...
    if (pindexPrev->nHeight >= PROOF_OF_WORK_BLOCKS) {
